...
"""Send deterministic complex 32-point stimulus and verify FPGA FFT output.

This script generates a reproducible complex128 test vector, packs each sample
into a 128-bit word ([127:64]=imag lane, [63:0]=real lane), sends the words
over UART, receives 128-bit FFT output words from FPGA, and compares the result
against numpy.fft.fft using configurable tolerances.

The UART wire format is little-endian, 16 bytes per complex sample.
"""
