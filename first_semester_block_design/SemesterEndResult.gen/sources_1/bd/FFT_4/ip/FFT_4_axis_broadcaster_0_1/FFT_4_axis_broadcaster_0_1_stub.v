...
//               c:/School/CSE485/FPGA_TB/FPGA_TB.gen/sources_1/bd/FFT_4/ip/FFT_4_axis_broadcaster_0_1/FFT_4_axis_broadcaster_0_1_stub.v
...
(* CHECK_LICENSE_TYPE = "FFT_4_axis_broadcaster_0_1,top_FFT_4_axis_broadcaster_0_1,{}" *) (* CORE_GENERATION_INFO = "FFT_4_axis_broadcaster_0_1,top_FFT_4_axis_broadcaster_0_1,{x_ipProduct=Vivado 2025.1,x_ipVendor=xilinx.com,x_ipLibrary=ip,x_ipName=axis_broadcaster,x_ipVersion=1.1,x_ipCoreRevision=34,x_ipLanguage=VERILOG,x_ipSimLanguage=VERILOG,C_FAMILY=spartan7,C_NUM_MI_SLOTS=4,C_S_AXIS_TDATA_WIDTH=256,C_M_AXIS_TDATA_WIDTH=64,C_AXIS_TID_WIDTH=5,C_AXIS_TDEST_WIDTH=2,C_S_AXIS_TUSER_WIDTH=32,C_M_AXIS_TUSER_WIDTH=32,C_AXIS_SIGNAL_SET=0b00000000000000000000000011110011}" *) (* DowngradeIPIdentifiedWarnings = "yes" *) 
(* X_CORE_INFO = "top_FFT_4_axis_broadcaster_0_1,Vivado 2025.1" *) 
module FFT_4_axis_broadcaster_0_1(aclk, aresetn, s_axis_tvalid, s_axis_tready, 
...
/* synthesis syn_black_box black_box_pad_pin="aresetn,s_axis_tvalid,s_axis_tready,s_axis_tdata[255:0],s_axis_tlast,s_axis_tid[4:0],s_axis_tdest[1:0],s_axis_tuser[31:0],m_axis_tvalid[3:0],m_axis_tready[3:0],m_axis_tdata[255:0],m_axis_tlast[3:0],m_axis_tid[19:0],m_axis_tdest[7:0],m_axis_tuser[127:0]" */
