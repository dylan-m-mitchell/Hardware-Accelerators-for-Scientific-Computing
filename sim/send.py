...
"""Send deterministic 128-bit test words to FPGA and verify returned data.

This script builds a fixed set of unsigned 128-bit values, transmits them over
UART as little-endian 16-byte words, receives the same number of 128-bit words
back from the FPGA, and verifies each returned word against a software model.

Reference behavior in this flow expects the FPGA path to return a full bit-wise
reversal of each 128-bit input word.
"""
